...
from metodosHTTP.cliente import obtener_clientes, registrar_cliente
from metodosHTTP.empleado import obtener_empleado, registrar_empleado
from metodosHTTP.empresa import obtener_empresa, registrar_empresa
from metodosHTTP.desecho import obtener_desecho, registrar_desecho
from metodosHTTP.entrega import obtener_entrega, registrar_entrega
from metodosHTTP.recoleccion import obtener_recoleccion, registrar_recoleccion
...
def post_3():
    ...
    cursor = conexion.connection.cursor()
    return registrar_empresa(request.json, cursor, conexion)
